...
void AMovableCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AMovableCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AMovableCharacter::MoveRight);
...
void AMovableCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AMovableCharacter::MoveForward(float Value)
{
...
void AMovableCharacter::MoveRight(float Value)
{
	if ((Controller != NULL) && (Value != 0.0f))
	{
